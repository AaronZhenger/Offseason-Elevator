...
public class DiffyIOTalonFXBadFriction implements DiffyIO {
  ...
  public DiffyIOTalonFXBadFriction() {
  ...
  @Override
  public void setLeaderPivotPosition(Angle angle) {
    pivotLeaderMotor.setSetpoint(new Rotation2d(angle));
  }

  @Override
  public void setLeaderPivotPosition(Rotation2d angle) {
    pivotLeaderMotor.setSetpoint(angle);
  }

  @Override
  public void setLeaderPivotPosition(double degrees) {
    pivotLeaderMotor.setEncoderPosition(Rotation2d.fromDegrees(degrees));
  }

  @Override
  public void setFollowerPivotPosition(Angle angle) {
    pivotFollowerMotor.setSetpoint(new Rotation2d(angle));
  }

  @Override
  public void setFollowerPivotPosition(Rotation2d angle) {
    pivotFollowerMotor.setSetpoint(angle);
  }

  @Override
  public void setFollowerPivotPosition(double degrees) {
    pivotFollowerMotor.setEncoderPosition(Rotation2d.fromDegrees(degrees));
  }
}
